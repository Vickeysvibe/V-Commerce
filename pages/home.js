    ...
    <Layout>
      <div className="bg-white overflow-scroll h-full">
        <div class="bg-white relative   flex items-center  n justify-center overflow-hidden z-50 ">
          <div class="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
            <div class="flex flex-col items-center justify-between lg:flex-row py-16">
              ...
              <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
                ...
                >
                  <img src="https://img.freepik.com/free-vector/user-rating-feedback-customer-reviews-cartoon-web-icon-e-commerce-online-shopping-internet-buying-trust-metrics-top-rated-product_335657-2332.jpg" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class=" absolute -bottom-24 left-10 z-0  opacity-10 ">
            <svg
              ...
              height="800px"
              viewBox="0 0 24 24"
              class="w-96 z-0  h-full    object-fill fill-gray-300 text-gray-300"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
        ...
        <div className="mx-auto max-w-full px-4 py-16 sm:px-6 sm:py-24 lg:max-w-screen-xl lg:px-8 ">
          <h2 className=" text-2xl mb-6 font-bold">Latest</h2>
          ...
          <div class="w-full flex items-start px-4 py-6">
            ...
            <div style={{ width: "80%" }}>
              ...
              >
                ...
                <small class="text-sm text-gray-700">moments ago</small>
              </div>
